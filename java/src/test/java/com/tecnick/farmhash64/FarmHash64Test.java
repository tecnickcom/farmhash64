...
public class FarmHash64Test {
    ...
    private static Stream<Arguments> hashTestData_Parameters() throws Throwable {
        ...
        return Stream.of(
            ...
            Arguments.of(0x47f9c,    0xa2b8bf3032021993L, "Give me a rock, paper and scissors and I will move the world.  CCFestoon"),
            ...
            Arguments.of(0xc401a0bf,  0x98eff6958c5e91aL, "The fugacity of a constituent in a mixture of gases at a given temperature is proportional to its mole fraction.  Lewis-Randall Rule"),
